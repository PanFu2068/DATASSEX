...
#group entity-attack-by-warden
#require cause ENTITY_ATTACK
#require killer WARDEN
#then discord
#message:
#- &e{player} &7was mistreated by Warden
...
#then discord
message:
- &e{player} &7had his head in a block for too long
...
- &e{player} &7forgot to look where he was walking
...
- &e{player} &7fell on his sword... ouch
